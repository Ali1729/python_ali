...
print("Mary1's account is account number:", len(accountNamesList))
newAccount("Mary1", 123451, 'nuts1')

print("Mary2's account is account number:", len(accountNamesList))
newAccount("Mary2", 123452, 'nuts2')
